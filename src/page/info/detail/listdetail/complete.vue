...
<div>
    <div class="head">
            ...
            <div class="list" v-for="(item,index) in completeData" :key="index">
...
<script>
import {completeList} from '@/api/getData'
...
export default {
    ...
    methods: {
        async initData(){
            const complete = await completeList()
            this.completeData = complete.data
