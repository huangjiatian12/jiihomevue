...
<div>
    <div class="head">
            ...
            <div class="list" v-for="(item,index) in receiptData" :key="index">
...
<script>
import {receiptList} from '@/api/getData'
...
export default {
    ...
    methods: {
        async initData() {
            const receipt = await receiptList()
            this.receiptData = receipt.data
            console.log(receipt)
        },
        isChooseAll(){
